...
namespace SharedObjects.StoredProcedures
{
    public class SPAdmin
    {
        ...
        public static string Access_UserRole_get = "call usp_Access_UserRole_Get";
        ...
        public static string Access_UserRole_update = "call usp_Access_UserRole_update (@p0,@p1,@p2,@p3,@p4)";
        public static string Access_UserRole_delete = "call usp_Access_UserRole_delete (@p0,@p1)";
